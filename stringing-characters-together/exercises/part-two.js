...
console.log(`Fifth gene: ${dnaTwo.slice(16, 19)}`);
//4) Use a template literal to print, "The DNA strand is ___ characters long."
console.log(`The DNA strand is ${dnaTwo.length} characters long.`)
//5) Just for fun, apply methods to ``dna`` and use another template literal to print, 'taco cat'.
console.log(`${dnaTwo.slice(dnaTwo.lastIndexOf("TAC"), dnaTwo.lastIndexOf("TAC") + 3).toLowerCase()}`+ 'o ' + `${dnaTwo.slice(dnaTwo.lastIndexOf("CAT"), dnaTwo.lastIndexOf("CAT") + 3).toLowerCase()}`);
